...
async function main() {
  ...
  {
    //交易先锋 https://nft2.blex.io/A-F/10-14.png
    const addressList = [
      "0x22b147A9e4E513d39775504EB7Db3D674D53d5dd"
    ]
    const uriList: string[] = []
    uriList.push(`https://nft2.blex.io/A/${10}.png`)
    await mint(addressList,uriList)
  }

  {
    //交易大师 https://nft1.blex.io/A-F/01-09.png
    const addressList = [
      "0x22b147A9e4E513d39775504EB7Db3D674D53d5dd"
    ]
    const uriList: string[] = []
    uriList.push(`https://nft1.blex.io/A/0${1}.png`)
    await mint(addressList,uriList)
  }
